...
def list_accounts():
    ...
    # FIX: Tests expect: { "accounts": [...] }
    return jsonify({"accounts": results}), status.HTTP_200_OK
...
def create_accounts():
    ...
    # FIX: use request.is_json (tests check this!)
...
def get_account(account_id):
    ...
    # FIX: Tests expect 201 CREATED (not 200)
